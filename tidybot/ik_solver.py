...
class IKSolver:
    def __init__(self, ee_offset=0.0):
        ...
        self.model = mujoco.MjModel.from_xml_path('models/ufactory_xarm7/xarm7_nohand.xml')
    ...
    def forward_kinematics(self, qpos):
        ...
        quat = np.empty(4)
        mujoco.mju_mat2Quat(quat, self.data.site(self.site_id).xmat)
        return pos, quat  # quat in (w, x, y, z)
